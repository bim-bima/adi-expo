            ...
            <form action="{{ route('daftar.cerdas.cermat') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_ketua"
                        placeholder="Masukkan Nama Lengkap Anda" name="nama_ketua">
                </div>
                <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-6">
                        <a href=""><button type="submit" class="btn-registrasi">Kirim</button></a>
                    </div>
                </div>
