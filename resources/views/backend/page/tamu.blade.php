                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="/admin/tamu/add" class="btn btn-primary float-end btn-sm">Add</a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="{{ asset('storage/image/tamu/' . $tamu->image) }}"
                                                ...
                                                <td>
                                                    ...
                                                    <p class="text-xs text-secondary mb-0">{{ $tamu->deskripsi }}</p>
                                                </td>

                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $tamu->created_at->format('D M Y') }}</span>
                                                </td>
                                                <td class="align-middle">
                                                    <a href="/admin/tamu/edit/{{ $tamu->id }}"
                                                        class="text-secondary font-weight-bold text-xs"
                                                        data-toggle="tooltip" data-original-title="Edit user">
                                                        Edit
                                                    </a>

                                                    <form action="/admin/tamu/delete/{{ $tamu->id }}" method="POST"
                                                        class="d-inline">
                                                        @csrf
                                                        @method('delete')
