    ...
    <section>
        ...
        <div class="container ps-5 pe-5">
            ...
            <form action="{{ route('addSponsor') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Nama Sponsor :</label>
                    <input class="form-control" name="nama_sponsor" id="exampleInputEmail1" aria-describedby="emailHelp" />

                </div>
                <div class="mb-3">
                    <label for="image">
                        <span>
                            <p class="form-label">Upload Logo Sponsor :</p>
